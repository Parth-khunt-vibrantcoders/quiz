...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
        ...
        <div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
            ...
            <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                ...
                <a href="#" class="text-center pt-2">
                    <img src="{{  asset('public/upload/systemsetting/logo.png') }}" class="max-h-110px" alt="" style="width: 250px;"/>
                </a>
                <!--end::Logo-->
                <!--begin::Aside body-->
        ...
        <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0 login-bg text-white" style="background-color: #96c3f2">
           ...
           <!--begin::Image-->
					<div class="content-img d-flex flex-row-fluid bgi-no-repeat  bgi-position-x-center" style="background-image: url({{  asset('public/backend/media/bg/login.png') }}) ; background-size:cover"></div>
            <!--end::Image-->
            <!--end::Image-->
        </div>
        <!--end::Content-->
