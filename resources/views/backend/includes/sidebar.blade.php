...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside" >
    ...
    <div class="brand flex-column-auto" id="kt_brand" >
        ...
        <a href="{{ route('my-dashboard') }}" class="brand-logo">
            <img alt="Logo" src="{{  asset('public/upload/systemsetting/logo-white.png') }}" class="max-h-35px" />
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
...
<li class="menu-item menu-item-submenu {{ $currentRoute == 'quiz-type-list'  || $currentRoute == 'quiz-type-add' || $currentRoute == 'quiz-type-edit' ||
                    $currentRoute == 'quiz-category-list'  || $currentRoute == 'quiz-category-add' || $currentRoute == 'quiz-category-edit' ||
                    $currentRoute == 'quiz-view'  ||  $currentRoute == 'quiz-list'  || $currentRoute == 'quiz-add' || $currentRoute == 'quiz-edit' ||  $currentRoute == 'quiz-add-question' || $currentRoute == 'quiz-edit-question' ? 'menu-item-open menu-item-active' :'' }}" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item {{  $currentRoute == 'quiz-view'  ||  $currentRoute == 'quiz-list'  || $currentRoute == 'quiz-add' || $currentRoute == 'quiz-edit' ||$currentRoute == 'quiz-add-question' || $currentRoute == 'quiz-edit-question' ? 'menu-item-active' : ''}}" aria-haspopup="true">
